...
describe('favorite blog', () => {
    ...
    test('when list has only one author', () => {
        ...
        const expectedResult = { author: 'Edsger W. Dijkstra', title: 'Go To Statement Considered Harmful', likes: 5 }
        assert.deepStrictEqual(result, expectedResult)
    })

    test('when list has multiple authors', () => {
        const result = listHelper.favoriteBlog(listWithMultipleBlogs)
        const expectedResult = { author: 'Edsger W. Dijkstra', title: 'Canonical string reduction', likes: 12 }
        assert.deepStrictEqual(result, expectedResult)
    })
})
